...
int main() {
    ...
    std::shared_ptr<core::Texture> tileSetTexture = std::make_shared<core::Texture>("tiled/AdvancedRendering.tsx", true);
    std::shared_ptr<core::Texture> tileMapTexture = std::make_shared<core::Texture>("tiled/Advanced rendering.tmx", 0);
    ...
    std::shared_ptr<core::Material> tileMapMaterial = std::make_shared<core::Material>(tileMapShaderProgram, mainCamera, tileSetTexture, tileMapTexture, "tiled/AdvancedRendering.tsx");
